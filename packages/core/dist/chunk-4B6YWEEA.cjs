...
var chunkJCZJNYPB_cjs = require('./chunk-JCZJNYPB.cjs');
...
function bootstrapMiddleware(config = {}) {
  return async (c, next) => {
    ...
    try {
      ...
      const migrationService = new chunkJCZJNYPB_cjs.MigrationService(c.env.DB);
...
//# sourceMappingURL=chunk-4B6YWEEA.cjs.map
//# sourceMappingURL=chunk-4B6YWEEA.cjs.map