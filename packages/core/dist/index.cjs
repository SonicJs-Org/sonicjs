...
var chunkJIA42EEJ_cjs = require('./chunk-JIA42EEJ.cjs');
...
function createDatabaseToolsAdminRoutes() {
  ...
  router3.use("*", chunk3QZWGHUM_cjs.requireAuth());
    ...
    try {
      switch (rec.category) {
        case "synonym": {
          ...
          const synonymService = new chunkJIA42EEJ_cjs.SynonymService(this.db);
        ...
        case "query_rule": {
          ...
          const rulesService = new chunkJIA42EEJ_cjs.QueryRulesService(this.db);
...
adminRoutes.use("*", chunk3QZWGHUM_cjs.requireAuth());
adminRoutes.get("/", async (c) => {
  try {
    ...
    const service = new chunkJIA42EEJ_cjs.AISearchService(db, ai, vectorize, kv);
    const indexer = new chunkJIA42EEJ_cjs.IndexManager(db, ai, vectorize);
    const fts5Service = new chunkJIA42EEJ_cjs.FTS5Service(db);
    let settings = null;
    try {
    ...
    return c.html(
      chunkJIA42EEJ_cjs.renderSearchDashboard({
        settings,
...
adminRoutes.post("/", async (c) => {
  try {
    ...
    const ai = c.env.AI;
    const vectorize = c.env.VECTORIZE_INDEX;
    const service = new chunkJIA42EEJ_cjs.AISearchService(db, ai, vectorize);
    const indexer = new chunkJIA42EEJ_cjs.IndexManager(db, ai, vectorize);
    const body = await c.req.json();
...
adminRoutes.post("/api/vectorize/reindex-all", async (c) => {
  try {
    ...
    try {
      const benchmarkIds = [];
      for (const dsId of chunkJIA42EEJ_cjs.BENCHMARK_DATASETS.map((d) => d.id)) {
        for (let i = 0; i < 6e3; i++) {
...
adminRoutes.post("/api/relevance/preview", async (c) => {
  try {
    ...
    const service = new chunkJIA42EEJ_cjs.AISearchService(db);
    const settings = await service.getSettings();
    ...
    const pipelineService = new chunkJIA42EEJ_cjs.RankingPipelineService(db);
...
adminRoutes.get("/api/relevance/pipeline", async (c) => {
  try {
    const pipelineService = new chunkJIA42EEJ_cjs.RankingPipelineService(c.env.DB);
    const config = await pipelineService.getConfig();
...
adminRoutes.get("/api/relevance/synonyms", async (c) => {
  try {
    const synonymService = new chunkJIA42EEJ_cjs.SynonymService(c.env.DB);
...
adminRoutes.get("/api/relevance/rules", async (c) => {
  try {
    const rulesService = new chunkJIA42EEJ_cjs.QueryRulesService(c.env.DB);
...
adminRoutes.get("/api/related-searches", async (c) => {
  try {
    const service = new chunkJIA42EEJ_cjs.RelatedSearchService(c.env.DB, c.env.CACHE_KV);
...
adminRoutes.get("/api/facets/discover", async (c) => {
  try {
    const facetService = new chunkJIA42EEJ_cjs.FacetService(c.env.DB);
...
adminRoutes.get("/api/facets/config", async (c) => {
  try {
    const service = new chunkJIA42EEJ_cjs.AISearchService(c.env.DB);
    const settings = await service.getSettings();
...
adminRoutes.get("/api/benchmark/datasets", async (c) => {
  return c.json({ success: true, datasets: chunkJIA42EEJ_cjs.BENCHMARK_DATASETS });
});
adminRoutes.get("/api/benchmark/status", async (c) => {
  try {
    ...
    const benchmarkService = new chunkJIA42EEJ_cjs.BenchmarkService(db, kv, void 0, dataset);
...
adminRoutes.post("/api/benchmark/purge", async (c) => {
  try {
    ...
    const body = await c.req.json().catch(() => ({}));
    const dataset = body.dataset || "scifact";
    const benchmarkService = new chunkJIA42EEJ_cjs.BenchmarkService(db, kv, vectorize, dataset);
...
adminRoutes.post("/api/benchmark/index-vectorize-batch", async (c) => {
  try {
    ...
    const datasetInfo = chunkJIA42EEJ_cjs.BENCHMARK_DATASETS.find((d) => d.id === dataset);
    const displayName = datasetInfo ? `${datasetInfo.name} Benchmark` : `BEIR ${dataset} Benchmark`;
    const embeddingService = new chunkJIA42EEJ_cjs.EmbeddingService(ai);
    const chunkingService = new chunkJIA42EEJ_cjs.ChunkingService();
...
adminRoutes.post("/api/benchmark/evaluate", async (c) => {
  try {
    ...
    const aiSearchService = new chunkJIA42EEJ_cjs.AISearchService(db, ai, vectorize);
...
apiRoutes.use("*", chunk3QZWGHUM_cjs.optionalAuth());
apiRoutes.use("*", chunk3QZWGHUM_cjs.optionalApiKey());
...
apiRoutes.get("/related", async (c) => {
  try {
    ...
    const service = new chunkJIA42EEJ_cjs.RelatedSearchService(db, kv);
...
apiRoutes.get("/trending", async (c) => {
  try {
    ...
    const service = new chunkJIA42EEJ_cjs.TrendingSearchService(db, kv);
...
instantSearchRoutes.post("/", async (c) => {
  try {
    ...
    const vectorize = c.env.VECTORIZE_INDEX;
    const kv = c.env.CACHE_KV;
    const searchService = new chunkJIA42EEJ_cjs.AISearchService(db, ai, vectorize, kv);
...
function createMagicLinkAuthPlugin() {
  ...
  magicLinkRoutes.get("/verify", async (c) => {
    try {
      ...
      const jwtToken = await chunk3QZWGHUM_cjs.AuthManager.generateToken(
        user.id,
        user.email,
        user.role
      );
      chunk3QZWGHUM_cjs.AuthManager.setAuthCookie(c, jwtToken);
      await db.prepare(`
...
function renderCacheDashboard(data) {
  const pageContent = `
    ...
    ${chunkJIA42EEJ_cjs.renderConfirmationDialog({
    ...
    ${chunkJIA42EEJ_cjs.getConfirmationDialogScript()}
  `;
  const layoutData = {
    title: "Cache System",
...
function createSonicJSApp(config = {}) {
  ...
  app2.use("*", chunk3QZWGHUM_cjs.metricsMiddleware());
  app2.use("*", chunk3QZWGHUM_cjs.bootstrapMiddleware(config));
  ...
  app2.route("/api", chunkJIA42EEJ_cjs.api_default);
  app2.route("/api/media", chunkJIA42EEJ_cjs.api_media_default);
  app2.route("/api/system", chunkJIA42EEJ_cjs.api_system_default);
  app2.route("/admin/api", chunkJIA42EEJ_cjs.admin_api_default);
  app2.route("/admin/dashboard", chunkJIA42EEJ_cjs.router);
  app2.route("/admin/collections", chunkJIA42EEJ_cjs.adminCollectionsRoutes);
  app2.route("/admin/forms", chunkJIA42EEJ_cjs.adminFormsRoutes);
  app2.route("/admin/settings", chunkJIA42EEJ_cjs.adminSettingsRoutes);
  app2.route("/forms", chunkJIA42EEJ_cjs.public_forms_default);
  app2.route("/api/forms", chunkJIA42EEJ_cjs.public_forms_default);
  app2.route("/admin/api-reference", chunkJIA42EEJ_cjs.router2);
  app2.route("/admin/database-tools", createDatabaseToolsAdminRoutes());
  app2.route("/admin/seed-data", createSeedDataAdminRoutes());
  app2.route("/admin/content", chunkJIA42EEJ_cjs.admin_content_default);
  app2.route("/admin/media", chunkJIA42EEJ_cjs.adminMediaRoutes);
  app2.route("/admin/search", chunkJIA42EEJ_cjs.adminSearchRoutes);
  app2.route("/admin/api-keys", chunkJIA42EEJ_cjs.adminApiKeyRoutes);
  ...
  app2.route("/admin/plugins", chunkJIA42EEJ_cjs.adminPluginRoutes);
  app2.route("/admin/logs", chunkJIA42EEJ_cjs.adminLogsRoutes);
  app2.route("/admin", chunkJIA42EEJ_cjs.userRoutes);
  app2.route("/auth", chunkJIA42EEJ_cjs.auth_default);
  app2.route("/", chunkJIA42EEJ_cjs.test_cleanup_default);
...
Object.defineProperty(exports, "ROUTES_INFO", {
  enumerable: true,
  get: function () { return chunkJIA42EEJ_cjs.ROUTES_INFO; }
});
Object.defineProperty(exports, "adminApiRoutes", {
  enumerable: true,
  get: function () { return chunkJIA42EEJ_cjs.admin_api_default; }
});
Object.defineProperty(exports, "adminCheckboxRoutes", {
  enumerable: true,
  get: function () { return chunkJIA42EEJ_cjs.adminCheckboxRoutes; }
});
Object.defineProperty(exports, "adminCodeExamplesRoutes", {
  enumerable: true,
  get: function () { return chunkJIA42EEJ_cjs.admin_code_examples_default; }
});
Object.defineProperty(exports, "adminCollectionsRoutes", {
  enumerable: true,
  get: function () { return chunkJIA42EEJ_cjs.adminCollectionsRoutes; }
});
Object.defineProperty(exports, "adminContentRoutes", {
  enumerable: true,
  get: function () { return chunkJIA42EEJ_cjs.admin_content_default; }
});
Object.defineProperty(exports, "adminDashboardRoutes", {
  enumerable: true,
  get: function () { return chunkJIA42EEJ_cjs.router; }
});
Object.defineProperty(exports, "adminDesignRoutes", {
  enumerable: true,
  get: function () { return chunkJIA42EEJ_cjs.adminDesignRoutes; }
});
Object.defineProperty(exports, "adminLogsRoutes", {
  enumerable: true,
  get: function () { return chunkJIA42EEJ_cjs.adminLogsRoutes; }
});
Object.defineProperty(exports, "adminMediaRoutes", {
  enumerable: true,
  get: function () { return chunkJIA42EEJ_cjs.adminMediaRoutes; }
});
Object.defineProperty(exports, "adminPluginRoutes", {
  enumerable: true,
  get: function () { return chunkJIA42EEJ_cjs.adminPluginRoutes; }
});
Object.defineProperty(exports, "adminSettingsRoutes", {
  enumerable: true,
  get: function () { return chunkJIA42EEJ_cjs.adminSettingsRoutes; }
});
Object.defineProperty(exports, "adminTestimonialsRoutes", {
  enumerable: true,
  get: function () { return chunkJIA42EEJ_cjs.admin_testimonials_default; }
});
Object.defineProperty(exports, "adminUsersRoutes", {
  enumerable: true,
  get: function () { return chunkJIA42EEJ_cjs.userRoutes; }
});
Object.defineProperty(exports, "apiContentCrudRoutes", {
  enumerable: true,
  get: function () { return chunkJIA42EEJ_cjs.api_content_crud_default; }
});
Object.defineProperty(exports, "apiMediaRoutes", {
  enumerable: true,
  get: function () { return chunkJIA42EEJ_cjs.api_media_default; }
});
Object.defineProperty(exports, "apiRoutes", {
  enumerable: true,
  get: function () { return chunkJIA42EEJ_cjs.api_default; }
});
Object.defineProperty(exports, "apiSystemRoutes", {
  enumerable: true,
  get: function () { return chunkJIA42EEJ_cjs.api_system_default; }
});
Object.defineProperty(exports, "authRoutes", {
  enumerable: true,
  get: function () { return chunkJIA42EEJ_cjs.auth_default; }
});
...
Object.defineProperty(exports, "AuthManager", {
  enumerable: true,
  get: function () { return chunk3QZWGHUM_cjs.AuthManager; }
});
Object.defineProperty(exports, "PermissionManager", {
  enumerable: true,
  get: function () { return chunk3QZWGHUM_cjs.PermissionManager; }
});
Object.defineProperty(exports, "bootstrapMiddleware", {
  enumerable: true,
  get: function () { return chunk3QZWGHUM_cjs.bootstrapMiddleware; }
});
Object.defineProperty(exports, "cacheHeaders", {
  enumerable: true,
  get: function () { return chunk3QZWGHUM_cjs.cacheHeaders; }
});
Object.defineProperty(exports, "compressionMiddleware", {
  enumerable: true,
  get: function () { return chunk3QZWGHUM_cjs.compressionMiddleware; }
});
Object.defineProperty(exports, "detailedLoggingMiddleware", {
  enumerable: true,
  get: function () { return chunk3QZWGHUM_cjs.detailedLoggingMiddleware; }
});
Object.defineProperty(exports, "getActivePlugins", {
  enumerable: true,
  get: function () { return chunk3QZWGHUM_cjs.getActivePlugins; }
});
Object.defineProperty(exports, "isPluginActive", {
  enumerable: true,
  get: function () { return chunk3QZWGHUM_cjs.isPluginActive; }
});
Object.defineProperty(exports, "logActivity", {
  enumerable: true,
  get: function () { return chunk3QZWGHUM_cjs.logActivity; }
});
Object.defineProperty(exports, "loggingMiddleware", {
  enumerable: true,
  get: function () { return chunk3QZWGHUM_cjs.loggingMiddleware; }
});
Object.defineProperty(exports, "optionalAuth", {
  enumerable: true,
  get: function () { return chunk3QZWGHUM_cjs.optionalAuth; }
});
Object.defineProperty(exports, "performanceLoggingMiddleware", {
  enumerable: true,
  get: function () { return chunk3QZWGHUM_cjs.performanceLoggingMiddleware; }
});
Object.defineProperty(exports, "requireActivePlugin", {
  enumerable: true,
  get: function () { return chunk3QZWGHUM_cjs.requireActivePlugin; }
});
Object.defineProperty(exports, "requireActivePlugins", {
  enumerable: true,
  get: function () { return chunk3QZWGHUM_cjs.requireActivePlugins; }
});
Object.defineProperty(exports, "requireAnyPermission", {
  enumerable: true,
  get: function () { return chunk3QZWGHUM_cjs.requireAnyPermission; }
});
Object.defineProperty(exports, "requireAuth", {
  enumerable: true,
  get: function () { return chunk3QZWGHUM_cjs.requireAuth; }
});
Object.defineProperty(exports, "requirePermission", {
  enumerable: true,
  get: function () { return chunk3QZWGHUM_cjs.requirePermission; }
});
Object.defineProperty(exports, "requireRole", {
  enumerable: true,
  get: function () { return chunk3QZWGHUM_cjs.requireRole; }
});
Object.defineProperty(exports, "securityHeaders", {
  enumerable: true,
  get: function () { return chunk3QZWGHUM_cjs.securityHeaders; }
});
Object.defineProperty(exports, "securityLoggingMiddleware", {
  enumerable: true,
  get: function () { return chunk3QZWGHUM_cjs.securityLoggingMiddleware; }
});
...
Object.defineProperty(exports, "MigrationService", {
  enumerable: true,
  get: function () { return chunk63CJSSOX_cjs.MigrationService; }
});
