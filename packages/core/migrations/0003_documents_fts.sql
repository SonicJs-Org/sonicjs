-- Migration 0003: Full-text search index (documents_fts)
...
--
-- EXACT 10-column layout (3 indexed + 7 UNINDEXED), matching the doc-FTS spike and
-- infowall content_fts so the engine's bm25(documents_fts, w0..w9) 10-weight vector maps 1:1.
