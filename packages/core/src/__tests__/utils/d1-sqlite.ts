...
export function createTestD1(): TestD1 {
  // Each new in-memory DB is a different schema world — caches built from the
  // previous DB's PRAGMA would tell ensureScalarSchema the q_* columns already
  // exist on this one, causing them to be silently skipped.
