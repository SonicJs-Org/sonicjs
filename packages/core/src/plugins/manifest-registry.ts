 ...
 * Generated at: 2026-09-12T19:58:43.834Z
...
export const PLUGIN_REGISTRY: Record<string, PluginRegistryEntry> = {
  'ai-search': {
    ...
    "description": "Content search with two engines: always-on full-text keyword search (FTS5 — relevance-ranked, stemmed, highlighted) plus optional AI semantic search when Workers AI + Vectorize bindings are configured.",
    "version": "1.1.0",
    "author": "SonicJS",
    "category": "content",
    "iconEmoji": "🔍",
