...
**Multi-tenancy**: First-class multi-tenant support (tenant switcher, role-based membership, email invitations) ships in v3.
...
- **GraphQL API layer**
- **Enhanced drag-and-drop page builder**
- **Expanded third-party integrations (Stripe, Auth0, etc.)**
...
Not yet. SonicJS is currently REST-only. GraphQL support is on our roadmap. If GraphQL is essential today, consider Strapi or Payload.
