...
// Short TTL for post lists, longer for individual posts
const postsListCache = new CacheService({ ttl: 60, keyPrefix: 'posts-list' })
const postsCache = new CacheService({ ttl: 3600, keyPrefix: 'posts' })
```
