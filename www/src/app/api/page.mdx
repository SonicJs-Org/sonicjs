...
- `fields` - Comma-separated list of fields to include in the response (field projection). Example: `?fields=id,title,slug` returns only those fields, reducing payload size.
