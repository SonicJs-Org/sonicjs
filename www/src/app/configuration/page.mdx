...
SonicJS supports `wrangler.toml`, `wrangler.json`, and `wrangler.jsonc` — use whichever format your project prefers. The examples below use TOML, but the same keys apply to the JSON/JSONC formats.
