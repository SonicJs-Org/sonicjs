...
import { renderTurnstileWidget } from '@sonicjs-cms/core'
import { TurnstileService } from '@sonicjs-cms/core'
...
```typescript
import { renderInlineTurnstile } from '@sonicjs-cms/core'
...
```typescript
import { renderExplicitTurnstile } from '@sonicjs-cms/core'
...
```typescript
import { verifyTurnstile } from '@sonicjs-cms/core'
...
```typescript
import { createTurnstileMiddleware } from '@sonicjs-cms/core'
...
const myPlugin = definePlugin({
  name: 'my-plugin',
  register(app) {
    app.route('/api/my-plugin/submit', submitRoutes)
    app.use('/api/my-plugin/submit', verifyTurnstile)
  },
})
```
