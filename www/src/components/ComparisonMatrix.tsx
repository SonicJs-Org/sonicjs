// This component syncs a sticky header scroller with the table scroller.
'use client'
...
const COLUMN_GRID_CLASS =
  'grid min-w-[920px] grid-cols-[190px_repeat(6,minmax(120px,1fr))]'
...
const SECTIONS: Section[] = [
  {
    ...
    rows: [
      ...
      {
        label: 'Edge / serverless runtime',
        cells: [yes, partial('Vercel'), no, no, partial('CDN'), partial('CDN')],
      },
      {
        label: 'Database',
        cells: [
      ...
      {
        label: 'Data layer / ORM',
        cells: ['Drizzle', 'Drizzle · Mongoose', 'Knex', 'Knex', 'GROQ', '—'],
      },
      {
        label: 'Typical cold start',
        cells: [
          '0–5 ms',
          '100–300 ms',
          '500–2000 ms',
  ...
  },
  {
    ...
    rows: [
      ...
      {
        label: 'Free to self-host',
        cells: [yes, yes, yes, partial('<$5M rev'), no, no],
      },
      {
        label: 'Free cloud tier',
        cells: [partial('CF free tier'), no, no, no, yes, yes],
      },
      {
        label: 'Paid cloud entry price',
        cells: [
          'Free / ~$5',
          '$35+/mo',
          '$15+/mo',
  ...
  },
  {
    ...
    rows: [
      {
        label: 'Collections / content types',
        cells: [yes, yes, yes, yes, yes, yes],
      },
      {
        label: 'Single types / globals',
        cells: [partial(), yes, yes, partial(), yes, partial()],
      },
      {
        label: 'Repeatable / array fields',
        cells: [yes, yes, yes, yes, yes, yes],
      },
      {
        label: 'Reusable component / group fields',
        cells: [yes, yes, yes, partial(), yes, partial()],
      },
      {
        label: 'Blocks / dynamic zones',
        cells: [yes, yes, yes, partial(), yes, yes],
      },
      {
        label: 'One-to-one relationships',
        cells: [partial(), yes, yes, yes, yes, yes],
      },
      {
      ...
      {
        label: 'Polymorphic relationships',
        cells: [partial(), yes, partial(), yes, yes, yes],
      },
      ...
      {
        label: 'Computed / virtual fields',
        cells: [no, partial(), partial(), partial(), partial(), no],
      },
      {
      ...
      },
      {
        ...
        cells: [yes, partial(), yes, yes, plugin(), yes],
      },
      { label: 'JSON field', cells: [yes, yes, yes, yes, partial(), yes] },
      {
        label: 'Custom field types',
        cells: [partial(), yes, yes, plugin(), yes, plugin()],
      },
      {
        label: 'UI / presentational fields',
        cells: [no, yes, partial(), yes, partial(), partial()],
      },
      {
        label: 'Field-level localization',
        cells: [soon(), yes, yes, yes, plugin(), yes],
      },
      {
        label: 'Built-in field types (approx.)',
        cells: ['~21', '~22', '~15', '~25', '~13', '~12'],
      },
    ],
  },
  {
    ...
    rows: [
      { label: 'Draft & publish', cells: [yes, yes, yes, yes, yes, yes] },
      {
        ...
        cells: [yes, yes, paid(), yes, partial('3-day free'), yes],
      },
      { label: 'Autosave', cells: [yes, yes, no, no, yes, yes] },
      {
        label: 'Scheduled publishing',
        cells: [yes, yes, paid(), partial('Flows'), paid(), paid()],
      },
      { label: 'Live preview', cells: [yes, yes, paid(), yes, yes, partial()] },
      {
        label: 'Editorial workflow / review stages',
        cells: [yes, partial(), paid(), partial(), partial(), paid()],
      },
      {
        label: 'Bulk edit / delete',
        cells: [yes, yes, yes, yes, partial(), yes],
      },
      { label: 'Document duplication', cells: [yes, yes, yes, yes, yes, yes] },
      {
        label: 'Soft delete / trash',
        cells: [no, yes, no, partial(), partial(), partial()],
      },
      {
        label: 'Concurrent edit locking',
        cells: [no, yes, partial(), partial(), yes, partial()],
      },
      { label: 'Editorial comments', cells: [no, no, no, yes, paid(), paid()] },
      {
        label: 'Real-time collaboration',
        cells: [no, no, no, no, yes, partial()],
      },
    ],
  },
  {
    ...
    rows: [
      ...
      {
        label: 'Filtering / sorting / pagination',
        cells: [yes, yes, yes, yes, yes, yes],
      },
      {
        label: 'Deep relationship population',
        cells: [partial(), yes, yes, yes, yes, yes],
      },
      {
        label: 'Aggregation queries',
        cells: [no, partial(), no, yes, yes, no],
      },
      {
        label: 'Field selection / sparse fieldsets',
        cells: [yes, yes, yes, yes, yes, yes],
      },
      {
        label: 'Custom endpoints',
        cells: [yes, yes, yes, plugin(), partial(), plugin()],
      },
      {
        label: 'OpenAPI / Swagger spec',
        cells: [yes, plugin(), yes, yes, no, partial()],
      },
    ],
  },
  {
    ...
    rows: [
      ...
      { label: 'API keys / tokens', cells: [yes, yes, yes, yes, yes, yes] },
      {
        ...
        cells: [plugin(), partial(), yes, yes, yes, partial()],
      },
      {
        label: 'SSO / SAML',
        cells: [soon(), paid(), paid(), yes, paid(), paid()],
      },
      { label: 'Magic link', cells: [plugin(), no, no, no, yes, no] },
      {
        label: 'OTP / 2FA / MFA',
        cells: [plugin('OTP'), plugin(), no, yes, partial(), yes],
      },
      {
        label: 'Role-based access control',
        cells: [yes, yes, partial('Adv = EE'), yes, partial('2 free'), paid()],
      },
      {
        label: 'Collection-level permissions',
        cells: [yes, yes, yes, yes, paid(), paid()],
      },
      {
        label: 'Field-level permissions',
        cells: [yes, yes, paid(), yes, paid(), paid()],
      },
      {
        label: 'Document / row-level access',
        cells: [partial(), yes, partial(), yes, paid(), paid()],
      },
      {
        label: 'Custom access-control functions',
        cells: [no, yes, yes, partial(), paid(), no],
      },
  ...
  },
  {
    ...
    rows: [
      ...
      {
        label: 'Image resizing / transforms',
        cells: [yes, yes, yes, yes, yes, yes],
      },
      { label: 'Focal point', cells: [no, yes, yes, yes, yes, yes] },
      {
        label: 'Cloud storage adapters',
        cells: ['R2', yes, plugin(), yes, no, no],
      },
      { label: 'File metadata', cells: [yes, yes, yes, yes, yes, yes] },
      {
        label: 'Alt text / captions',
      ...
      },
      {
        ...
        cells: [yes, partial(), partial(), partial(), yes, yes],
      },
    ],
  },
  {
    ...
    rows: [
      {
        label: 'Content localization (i18n)',
        cells: [soon(), yes, yes, yes, plugin(), yes],
      },
      {
        label: 'Locale fallbacks',
        cells: [soon(), yes, no, partial(), plugin(), yes],
      },
      {
        label: 'Admin UI translations',
        cells: [no, yes, yes, yes, yes, partial()],
      },
      {
        label: 'RTL support',
        cells: [no, yes, partial(), yes, partial(), yes],
      },
    ],
  },
  {
    ...
    rows: [
      ...
      {
        label: 'Custom components / fields',
        cells: [partial(), yes, yes, plugin(), yes, plugin()],
      },
      {
        label: 'Customizable dashboard',
        cells: [yes, yes, partial(), yes, yes, plugin()],
      },
      {
        label: 'Custom admin views / routes',
        cells: [yes, yes, yes, plugin(), yes, plugin()],
      },
      {
        label: 'Theming / white-label',
        cells: [partial(), yes, partial(), partial(), partial(), paid()],
      },
      { label: 'Dark mode', cells: [yes, yes, yes, yes, yes, no] },
      {
        label: 'List view configuration',
        cells: [yes, yes, yes, yes, yes, yes],
      },
      {
        label: 'Conditional field display',
  ...
  },
  {
    ...
    rows: [
      ...
      {
        label: 'Middleware',
        cells: [yes, partial(), yes, partial(), partial(), no],
      },
      {
        label: 'Custom endpoints',
        cells: [yes, yes, yes, yes, partial(), plugin()],
      },
      {
      ...
      },
      {
        ...
        cells: [no, yes, no, partial(), no, no],
      },
      { label: 'Email sending', cells: [yes, yes, plugin(), yes, no, no] },
      {
        label: 'Visual automation builder',
        cells: [no, no, no, yes, no, paid()],
      },
      {
        label: 'Custom CLI',
        cells: [no, partial(), partial(), partial(), yes, yes],
      },
    ],
  },
  {
    ...
    rows: [
      ...
      {
        label: 'Type generation from schema',
        cells: [partial(), yes, yes, partial(), yes, plugin()],
      },
      {
        label: 'DB / content migrations',
      ...
      {
        label: 'API playground / docs UI',
        cells: [yes, partial(), yes, partial(), yes, yes],
      },
    ],
  },
  {
    ...
    rows: [
      ...
      },
      {
        ...
        cells: [yes, yes, partial(), partial(), yes, partial()],
      },
      { label: 'CORS config', cells: [yes, yes, yes, yes, yes, yes] },
      {
        label: 'Audit logs',
        cells: [yes, partial(), paid(), yes, paid(), paid()],
      },
      { label: 'Field encryption', cells: [no, partial(), no, no, no, no] },
      {
        label: 'GDPR / data-export tools',
        cells: [partial(), partial(), partial(), yes, partial(), yes],
      },
      {
        label: 'Bot protection (CAPTCHA)',
        cells: [plugin('Turnstile'), no, no, no, partial(), partial()],
      },
    ...
    rows: [
      {
        ...
        cells: ['2018', '2021', '2015', '2012', '2017', '2013'],
      },
      {
        label: 'GitHub stars (approx.)',
        cells: ['~1.6k', '~43k', '~72k', '~36k', '~6.2k', 'Closed'],
      },
      {
      ...
      },
      {
        ...
        cells: [no, partial(), no, partial(), partial(), paid()],
      },
      {
        label: 'Built-in AI features',
        cells: [yes, no, paid(), no, partial(), paid()],
      },
    ],
  },
]
...
function MarkCell({ mark }: { mark: Mark }) {
  ...
  return (
    <span className="inline-flex flex-col items-center leading-tight">
      <span className={clsx('text-xs font-semibold', style.className)}>
        {style.label}
      </span>
      {mark.note && (
  ...
  return (
    <div className="not-prose my-10 w-full lg:!mx-0 lg:!max-w-none">
      <div className="mb-4 flex flex-wrap gap-x-5 gap-y-2 text-xs">
        <LegendItem
          swatch={<span className="font-bold text-emerald-500">✓</span>}
          label="Built-in"
        />
        <LegendItem
          swatch={<span className="text-gray-300 dark:text-gray-600">✗</span>}
          label="Not supported"
        />
        <LegendItem
          swatch={
      ...
      <p className="mb-2 text-right text-xs text-gray-400 xl:hidden dark:text-gray-500">
        6 products compared — scroll the table sideways to see Sanity &amp;
        Contentful →
      </p>
      <div
        ref={headerScrollRef}
        onScroll={(event) => syncHorizontalScroll(event, tableScrollRef)}
        className="sticky top-14 z-30 overflow-x-auto rounded-t-xl border border-b-0 border-gray-200 bg-blue-50 shadow-sm shadow-gray-950/5 [scrollbar-width:none] dark:border-gray-800 dark:bg-gray-900 dark:shadow-black/20 [&::-webkit-scrollbar]:hidden"
        data-comparison-header
      >
        <div className={COLUMN_GRID_CLASS} aria-hidden="true">
          <div className="sticky left-0 z-10 bg-blue-50 px-2.5 py-2.5 text-sm font-bold text-gray-900 dark:bg-gray-900 dark:text-white">
            Capability
          </div>
      ...
      <div
        ref={tableScrollRef}
        onScroll={(event) => syncHorizontalScroll(event, headerScrollRef)}
        className="overflow-x-auto rounded-b-xl border border-gray-200 dark:border-gray-800"
      >
        <table
          className={clsx(
              ...
              <Fragment key={section.title}>
                <tr>
                  <th
                    ...
                    className="bg-gray-50 px-3 py-2 text-left text-xs font-bold tracking-wider text-gray-500 uppercase dark:bg-gray-800/60 dark:text-gray-400"
                  >
                    {section.title}
                  </th>
                </tr>
                  ...
                  >
                    ...
                    {row.cells.map((cell, i) => (
                      <td
                        key={i}
                        className={clsx(
                          'px-2.5 py-2.5 text-center align-middle',
      ...
      <p className="mt-3 text-center text-xs text-gray-500 dark:text-gray-400">
        Data last verified {LAST_VERIFIED} against each project&rsquo;s official
        docs, GitHub, and pricing pages. Sanity and Contentful are hosted SaaS
        platforms, so &ldquo;self-hostable&rdquo; rows are No and several
